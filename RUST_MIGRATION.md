...
| **Rust port** | **Rust** | **Complete — 387 tests, validated against Python golden data + property-based stress tests** |
...
- **387 tests total** (includes 7 property-based tests via proptest)
