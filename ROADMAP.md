...
These are acknowledged as valuable but not in any planned phase:

- Synthesis tools (Burmester theory, function generation) — see Phase 6 note above
- Multi-DOF mechanisms (5-bar, parallel robots) — see Phase 6 note above
